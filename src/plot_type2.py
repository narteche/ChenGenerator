# -*- coding: utf-8 -*-
"""
Created on Mon Jul 22 23:58:31 2019
...
filename1 = "./output_files/times/" + "type2_quabs1.txt"
filename2 = "./output_files/times/" + "type2_quabs2.txt"
file1 = open(filename1, 'r')
file2 = open(filename2, 'r')
...
beingsaved = plt.figure()
plot(expo, x, y)
beingsaved.savefig('expoQUABS.svg', format='svg', dpi=1200)
beingsaved = plt.figure()
plot(cuadratic, x, y)
beingsaved.savefig('cuadraticQUABS.svg', format='svg', dpi=1200)
beingsaved = plt.figure()
plot(cubic, x, y)
beingsaved.savefig('cubicQUABS.svg', format='svg', dpi=1200)
beingsaved = plt.figure()
plot(cuart, x, y)
beingsaved.savefig('cuartQUABS.svg', format='svg', dpi=1200)
